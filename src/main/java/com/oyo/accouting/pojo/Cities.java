...
public class Cities {
  ...
  public Double getDealsNotificationValue() {
    return dealsNotificationValue;
  }

  public void setDealsNotificationValue(Double dealsNotificationValue) {
    this.dealsNotificationValue = dealsNotificationValue;
  }
